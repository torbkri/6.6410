...
%
% This file is MIT-Thesis_libertinus_headings_UA2.tex
%
...
\documentclass[twoside,fontset=libertinus,mydesign=mydesign_libertinus_headings]{mitthesis}
...
%
% option [boldcaplabel] sets caption labels in boldface (e.g., "Figure 1.1:", "Table 3.2:"). Only with formats later than 2025/11/01.
%
% option [boldcaption]  sets entire caption in boldface, including the label. Only with formats later than 2025/11/01.
%
...
%% Are your readers running off the page?  You can move the page heading upward by uncommenting this command:
% \CMPShortenTop
...
\appendix
\include{appendixa}% table examples
