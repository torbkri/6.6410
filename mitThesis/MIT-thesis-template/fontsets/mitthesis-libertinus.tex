...
\ProvidesFile{mitthesis-libertinus.tex}[2026/07/18 v1.04 Load Libertinus and related fonts]
...
\else
    ...
    \setmainfont{LibertinusSerif}[% 
		...
		% see: https://github.com/alerque/libertinus/blob/master/documentation/Opentype-Features.pdf
    ]    
